...
extern const float edgeThreshold = 0.27948933028037015;
extern const float surfThreshold = 0.10224431234792349;
extern const float nearestFeatureSearchSqDist = 34;
