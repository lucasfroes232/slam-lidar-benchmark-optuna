...
extern const float edgeThreshold = 0.2490067654250186;
extern const float surfThreshold = 0.020913632836709082;
extern const float nearestFeatureSearchSqDist = 21;
