...
extern const float edgeThreshold = 0.29145392872449155;
extern const float surfThreshold = 0.03850090888687968;
extern const float nearestFeatureSearchSqDist = 39;
