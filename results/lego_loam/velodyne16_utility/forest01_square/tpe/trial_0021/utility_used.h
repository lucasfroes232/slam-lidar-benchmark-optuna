...
extern const float edgeThreshold = 0.23065211253390716;
extern const float surfThreshold = 0.15251911539977703;
extern const float nearestFeatureSearchSqDist = 31;
