...
extern const float edgeThreshold = 0.24457660162006598;
extern const float surfThreshold = 0.09312024497722306;
extern const float nearestFeatureSearchSqDist = 38;
