...
extern const float edgeThreshold = 0.026969253205665178;
extern const float surfThreshold = 0.049257855051725835;
extern const float nearestFeatureSearchSqDist = 18;
