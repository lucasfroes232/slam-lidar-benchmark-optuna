...
extern const float edgeThreshold = 0.266300829877168;
extern const float surfThreshold = 0.13848998948302954;
extern const float nearestFeatureSearchSqDist = 41;
