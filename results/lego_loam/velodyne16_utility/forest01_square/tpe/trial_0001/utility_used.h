...
extern const float edgeThreshold = 0.1275937969781052;
extern const float surfThreshold = 0.20142276015767385;
extern const float nearestFeatureSearchSqDist = 33;
