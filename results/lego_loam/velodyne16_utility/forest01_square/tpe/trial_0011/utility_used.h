...
extern const float edgeThreshold = 0.2957779778862464;
extern const float surfThreshold = 0.020729252739405405;
extern const float nearestFeatureSearchSqDist = 36;
