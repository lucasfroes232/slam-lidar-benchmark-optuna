...
extern const float edgeThreshold = 0.2331020569978713;
extern const float surfThreshold = 0.07480920105902178;
extern const float nearestFeatureSearchSqDist = 43;
