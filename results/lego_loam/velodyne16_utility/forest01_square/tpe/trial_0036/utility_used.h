...
extern const float edgeThreshold = 0.2810309156491968;
extern const float surfThreshold = 0.22587019769268715;
extern const float nearestFeatureSearchSqDist = 22;
