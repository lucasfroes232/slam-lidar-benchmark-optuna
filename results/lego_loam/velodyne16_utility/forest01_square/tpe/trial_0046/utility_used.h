...
extern const float edgeThreshold = 0.2528543914311607;
extern const float surfThreshold = 0.02606053910610273;
extern const float nearestFeatureSearchSqDist = 35;
