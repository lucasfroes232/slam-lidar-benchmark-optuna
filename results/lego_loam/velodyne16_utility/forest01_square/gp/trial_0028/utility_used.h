...
extern const float edgeThreshold = 0.29999999999999993;
extern const float surfThreshold = 0.24100294104852432;
extern const float nearestFeatureSearchSqDist = 11;
