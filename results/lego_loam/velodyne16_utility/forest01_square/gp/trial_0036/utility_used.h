...
extern const float edgeThreshold = 0.17163488229463778;
extern const float surfThreshold = 0.2604006421946497;
extern const float nearestFeatureSearchSqDist = 13;
