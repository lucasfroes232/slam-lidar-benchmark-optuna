...
extern const float edgeThreshold = 0.19024032960031967;
extern const float surfThreshold = 0.12446962707992025;
extern const float nearestFeatureSearchSqDist = 40;
