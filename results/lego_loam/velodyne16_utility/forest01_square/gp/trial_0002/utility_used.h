...
extern const float edgeThreshold = 0.1511944988406466;
extern const float surfThreshold = 0.038677880311265164;
extern const float nearestFeatureSearchSqDist = 47;
