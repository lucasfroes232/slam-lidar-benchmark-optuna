...
extern const float edgeThreshold = 0.021742161508002514;
extern const float surfThreshold = 0.2101561363041892;
extern const float nearestFeatureSearchSqDist = 46;
