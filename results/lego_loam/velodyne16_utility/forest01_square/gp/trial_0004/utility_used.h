...
extern const float edgeThreshold = 0.04901057090676583;
extern const float surfThreshold = 0.16696725880358715;
extern const float nearestFeatureSearchSqDist = 12;
