...
extern const float edgeThreshold = 0.05348656117079535;
extern const float surfThreshold = 0.11164857155914054;
extern const float nearestFeatureSearchSqDist = 7;
