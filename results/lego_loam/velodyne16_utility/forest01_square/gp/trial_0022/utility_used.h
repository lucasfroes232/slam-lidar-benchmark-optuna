...
extern const float edgeThreshold = 0.1050397027125361;
extern const float surfThreshold = 0.08846872579572125;
extern const float nearestFeatureSearchSqDist = 45;
