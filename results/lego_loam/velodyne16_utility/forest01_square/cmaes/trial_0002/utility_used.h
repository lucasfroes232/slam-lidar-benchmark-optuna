...
extern const float edgeThreshold = 0.09062531208797896;
extern const float surfThreshold = 0.12684332762290365;
extern const float nearestFeatureSearchSqDist = 28;
