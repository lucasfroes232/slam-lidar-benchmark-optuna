...
extern const float edgeThreshold = 0.08168049836055982;
extern const float surfThreshold = 0.07608560225954628;
extern const float nearestFeatureSearchSqDist = 26;
