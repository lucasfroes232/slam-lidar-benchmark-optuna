...
extern const int groundScanInd = 8;
...
extern const float edgeThreshold = 0.061593529601820074;
extern const float surfThreshold = 0.12998741673241646;
extern const float nearestFeatureSearchSqDist = 29;
