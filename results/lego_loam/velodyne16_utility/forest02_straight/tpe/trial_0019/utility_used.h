...
extern const float edgeThreshold = 0.2696114642753526;
extern const float surfThreshold = 0.1835823023338421;
extern const float nearestFeatureSearchSqDist = 19;
