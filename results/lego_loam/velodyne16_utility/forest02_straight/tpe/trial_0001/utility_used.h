...
extern const float edgeThreshold = 0.29870652687657073;
extern const float surfThreshold = 0.05784863733329142;
extern const float nearestFeatureSearchSqDist = 37;
