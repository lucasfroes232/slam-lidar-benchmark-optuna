...
extern const float edgeThreshold = 0.22969746453232506;
extern const float surfThreshold = 0.040939613629518166;
extern const float nearestFeatureSearchSqDist = 30;
