...
extern const float edgeThreshold = 0.26915135004518537;
extern const float surfThreshold = 0.020755439003576057;
extern const float nearestFeatureSearchSqDist = 23;
