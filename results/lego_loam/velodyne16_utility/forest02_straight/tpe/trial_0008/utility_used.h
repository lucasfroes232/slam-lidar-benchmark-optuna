...
extern const float edgeThreshold = 0.09033819779370636;
extern const float surfThreshold = 0.2604909823180541;
extern const float nearestFeatureSearchSqDist = 44;
