...
extern const float edgeThreshold = 0.04066073835730688;
extern const float surfThreshold = 0.15564381716618056;
extern const float nearestFeatureSearchSqDist = 24;
