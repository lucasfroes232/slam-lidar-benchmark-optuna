...
extern const float edgeThreshold = 0.19390046256363236;
extern const float surfThreshold = 0.29726031567879313;
extern const float nearestFeatureSearchSqDist = 17;
